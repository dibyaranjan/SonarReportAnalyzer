...
@ContextConfiguration(classes = { SyncIssueController.class, SonarReportSynchronizer.class, BaseConverter.class,
        ConverterFactory.class, ConverterFactory.class, PageCrawlerBean.class, SourceFilePersisterItConfiguration.class,
        AspectConfiguration.class, SourceFilePersisterImpl.class })
