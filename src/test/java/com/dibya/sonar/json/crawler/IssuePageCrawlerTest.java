...
public class IssuePageCrawlerTest {
	private AbstractJsonCrawler<Page> crawler;
		...
		mockery.checking(new Expectations() {
			{
				...
				oneOf(restTemplate).getForObject("VALID-URL", Page.class);
				will(returnValue(null));
			}
		});

		crawler.setRestTemplate(restTemplate);
		Page page = crawler.retrieveJsonContentFromUrl("VALID-URL");
		Assert.assertNull("Page should be null", page);
	}
}
